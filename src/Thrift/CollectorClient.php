...
class CollectorClient implements \Jaeger\Thrift\CollectorIf
{
    ...
    public function submitBatches(?array $batches): ?array
    {
        $this->send_submitBatches($batches);
        return $this->recv_submitBatches();
    }

    public function send_submitBatches(?array $batches): void
    {
        ...
        if ($bin_accel) {
            ...
            $this->output->writeMessageBegin('submitBatches', TMessageType::CALL, $this->seqid);
    ...
    public function recv_submitBatches(): ?array
    {
