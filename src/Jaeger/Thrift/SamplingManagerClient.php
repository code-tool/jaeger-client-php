...
class SamplingManagerClient implements \CodeTool\OpenTracing\SamplingManagerIf {
  ...
  {
    $args = new \CodeTool\OpenTracing\SamplingManager_getSamplingStrategy_args();
  ...
  public function recv_getSamplingStrategy()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\SamplingManager_getSamplingStrategy_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \CodeTool\OpenTracing\SamplingManager_getSamplingStrategy_result();
