...
class Batch {
  ...
  static $_TSPEC = array(
    1 => array(
      ...
      'isRequired' => true,
      'type' => TType::STRUCT,
      'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Process',
      ),
    2 => array(
      'var' => 'spans',
      'isRequired' => true,
      ...
      'elem' => array(
        'type' => TType::STRUCT,
        'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Span',
        ),
      ),
    );

  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Process
   */
  public $process = null;
  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Span[]
   */
  public $spans = null;
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->process = new \CodeTool\OpenTracing\Jaeger\Thrift\Process();
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem40 = null;
              $elem40 = new \CodeTool\OpenTracing\Jaeger\Thrift\Span();
