...
class DependencyClient implements \CodeTool\OpenTracing\DependencyIf {
  ...
  {
    $args = new \CodeTool\OpenTracing\Dependency_getDependenciesForTrace_args();
  ...
  public function recv_getDependenciesForTrace()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\Dependency_getDependenciesForTrace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \CodeTool\OpenTracing\Dependency_getDependenciesForTrace_result();
  ...
  public function send_saveDependencies(\CodeTool\OpenTracing\Dependencies $dependencies)
  {
    $args = new \CodeTool\OpenTracing\Dependency_saveDependencies_args();
