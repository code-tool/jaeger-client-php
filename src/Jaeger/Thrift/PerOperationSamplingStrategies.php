...
class PerOperationSamplingStrategies {
  ...
  /**
   * @var \CodeTool\OpenTracing\OperationSamplingStrategy[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\CodeTool\OpenTracing\OperationSamplingStrategy',
            ),
          ),
        4 => array(
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \CodeTool\OpenTracing\OperationSamplingStrategy();
