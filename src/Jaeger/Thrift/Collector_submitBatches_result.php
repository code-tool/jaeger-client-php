...
class Collector_submitBatches_result {
  ...
  static $_TSPEC = array(
    0 => array(
      ...
      'elem' => array(
        'type' => TType::STRUCT,
        'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\BatchSubmitResponse',
        ),
      ),
    );

  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\BatchSubmitResponse[]
   */
  public $success = null;
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem54 = null;
              $elem54 = new \CodeTool\OpenTracing\Jaeger\Thrift\BatchSubmitResponse();
