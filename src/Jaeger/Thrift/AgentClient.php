...
class AgentClient implements \CodeTool\OpenTracing\AgentIf {
  ...
  {
    $args = new \CodeTool\OpenTracing\Agent_emitZipkinBatch_args();
    $args->spans = $spans;
  ...
  public function emitBatch(\CodeTool\OpenTracing\Batch $batch)
  {
    $this->send_emitBatch($batch);
  }

  public function send_emitBatch(\CodeTool\OpenTracing\Batch $batch)
  {
    $args = new \CodeTool\OpenTracing\Agent_emitBatch_args();
    $args->batch = $batch;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
