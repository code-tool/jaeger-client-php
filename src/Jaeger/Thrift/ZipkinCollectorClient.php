...
class ZipkinCollectorClient implements \CodeTool\OpenTracing\ZipkinCollectorIf {
  ...
  {
    $args = new \CodeTool\OpenTracing\ZipkinCollector_submitZipkinBatch_args();
    $args->spans = $spans;
  ...
  public function recv_submitZipkinBatch()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\ZipkinCollector_submitZipkinBatch_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \CodeTool\OpenTracing\ZipkinCollector_submitZipkinBatch_result();
