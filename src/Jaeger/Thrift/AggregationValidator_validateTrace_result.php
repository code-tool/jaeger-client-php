...
class AggregationValidator_validateTrace_result {
  ...
  /**
   * @var \CodeTool\OpenTracing\ValidateTraceResponse
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\CodeTool\OpenTracing\ValidateTraceResponse',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \CodeTool\OpenTracing\ValidateTraceResponse();
