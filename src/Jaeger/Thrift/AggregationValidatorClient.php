...
class AggregationValidatorClient implements \CodeTool\OpenTracing\AggregationValidatorIf {
  ...
  {
    $args = new \CodeTool\OpenTracing\AggregationValidator_validateTrace_args();
  ...
  public function recv_validateTrace()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\AggregationValidator_validateTrace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \CodeTool\OpenTracing\AggregationValidator_validateTrace_result();
