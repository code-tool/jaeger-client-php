...
class AggregationValidatorClient implements \CodeTool\OpenTracing\Jaeger\Thrift\Agent\AggregationValidatorIf {
  ...
  public function recv_validateTrace()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\AggregationValidator_validateTrace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
