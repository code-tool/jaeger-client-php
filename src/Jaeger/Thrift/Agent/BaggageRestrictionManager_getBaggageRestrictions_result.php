...
class BaggageRestrictionManager_getBaggageRestrictions_result {
  ...
  static $_TSPEC = array(
    0 => array(
      ...
      'elem' => array(
        'type' => TType::STRUCT,
        'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\BaggageRestriction',
        ),
      ),
    );

  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\BaggageRestriction[]
   */
  public $success = null;
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\BaggageRestriction();
