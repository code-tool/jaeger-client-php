...
class PerOperationSamplingStrategies {
  ...
  static $_TSPEC = array(
    ...
    3 => array(
      ...
      'elem' => array(
        'type' => TType::STRUCT,
        'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\OperationSamplingStrategy',
        ),
      ),
    4 => array(
  ...
  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\OperationSamplingStrategy[]
   */
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\OperationSamplingStrategy();
