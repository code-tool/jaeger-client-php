...
class Dependencies {
  ...
  static $_TSPEC = array(
    1 => array(
      ...
      'elem' => array(
        'type' => TType::STRUCT,
        'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\DependencyLink',
        ),
      ),
    );

  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\DependencyLink[]
   */
  public $links = null;
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\DependencyLink();
