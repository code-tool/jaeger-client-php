...
class BaggageRestrictionManagerClient implements \CodeTool\OpenTracing\Jaeger\Thrift\Agent\BaggageRestrictionManagerIf {
  ...
  public function recv_getBaggageRestrictions()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\BaggageRestrictionManager_getBaggageRestrictions_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
