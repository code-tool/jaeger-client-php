...
class AggregationValidator_validateTrace_result
{
    ...
    static $_TSPEC = array(
        0 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\ValidateTraceResponse',
        ),
    );

    /**
     * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\ValidateTraceResponse
     */
    public $success = null;
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\ValidateTraceResponse();
