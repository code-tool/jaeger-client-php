...
class SamplingManagerClient implements \CodeTool\OpenTracing\Jaeger\Thrift\Agent\SamplingManagerIf {
  ...
  public function recv_getSamplingStrategy()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\SamplingManager_getSamplingStrategy_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
