...
class DependencyClient implements \CodeTool\OpenTracing\Jaeger\Thrift\Agent\DependencyIf {
  ...
  public function recv_getDependenciesForTrace()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\Dependency_getDependenciesForTrace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
