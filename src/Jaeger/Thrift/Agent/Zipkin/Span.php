...
class Span {
  ...
  static $_TSPEC = array(
    ...
    6 => array(
      ...
      'elem' => array(
        'type' => TType::STRUCT,
        'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Annotation',
        ),
      ),
    8 => array(
      ...
      'elem' => array(
        'type' => TType::STRUCT,
        'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\BinaryAnnotation',
        ),
      ),
    9 => array(
      'var' => 'debug',
  ...
  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Annotation[]
   */
  public $annotations = null;
  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\BinaryAnnotation[]
   */
      ...
      switch ($fid)
      {
        ...
        case 6:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Annotation();
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem11 = null;
              $elem11 = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\BinaryAnnotation();
