...
class Annotation {
  ...
  static $_TSPEC = array(
    ...
    3 => array(
      ...
      'isRequired' => false,
      'type' => TType::STRUCT,
      'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Endpoint',
      ),
    );
   ...
   * 
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Endpoint
   */
  public $host = null;
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->host = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Endpoint();
