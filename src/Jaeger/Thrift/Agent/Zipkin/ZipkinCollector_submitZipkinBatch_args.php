...
class ZipkinCollector_submitZipkinBatch_args {
  ...
  static $_TSPEC = array(
    1 => array(
      ...
      'elem' => array(
        'type' => TType::STRUCT,
        'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Span',
        ),
      ),
    );

  /**
   * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Span[]
   */
  public $spans = null;
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\Zipkin\Span();
