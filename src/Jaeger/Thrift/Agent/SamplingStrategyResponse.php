...
class SamplingStrategyResponse
{
    ...
    static $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\ProbabilisticSamplingStrategy',
        ),
        3 => array(
            'var' => 'rateLimitingSampling',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\RateLimitingSamplingStrategy',
        ),
        4 => array(
            'var' => 'operationSampling',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\CodeTool\OpenTracing\Jaeger\Thrift\Agent\PerOperationSamplingStrategies',
        ),
    );
    ...
    /**
     * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\ProbabilisticSamplingStrategy
     */
    public $probabilisticSampling = null;

    /**
     * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\RateLimitingSamplingStrategy
     */
    public $rateLimitingSampling = null;

    /**
     * @var \CodeTool\OpenTracing\Jaeger\Thrift\Agent\PerOperationSamplingStrategies
     */
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->probabilisticSampling = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\ProbabilisticSamplingStrategy(
                        );
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->rateLimitingSampling = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\RateLimitingSamplingStrategy(
                        );
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->operationSampling = new \CodeTool\OpenTracing\Jaeger\Thrift\Agent\PerOperationSamplingStrategies(
                        );
