...
class CollectorClient implements \CodeTool\OpenTracing\Jaeger\Thrift\CollectorIf {
  ...
  public function recv_submitBatches()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\CodeTool\OpenTracing\Jaeger\Thrift\Collector_submitBatches_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
